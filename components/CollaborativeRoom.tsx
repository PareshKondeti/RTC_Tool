...
import PresenceAnnounce from './PresenceAnnounce';
...
const CollaborativeRoom = ({ roomId, roomMetadata, users, currentUserType }: CollaborativeRoomProps) => {
  ...
  // Join/leave toast notifications are handled inside RoomProvider via PresenceToasts component

  // Expose context for version save API (used by ToolbarPlugin)
  useEffect(() => {
